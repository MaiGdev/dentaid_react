...
const FormAlergia = () => {
  ...
  const alergiaSchema = yup.object({
    ...
    reaccion: yup
      .string()
      .required("Las reacciones son requeridas")
    ...
    observaciones: yup
      ...
      .max(150, "El nombre de usuario no puede tener más de 150 caracteres"),
    /*     if(esCrear) {
      categoria: yup.string().required("Debes seleccionar una opción");
    }, */
  });
  ...
  /* ct: categoria */
  const { dataCt, errorCt, loadedCt } = useCallApi({
    endpoint: `alergia/${id}`,
  });
            ...
            <form onSubmit={handleSubmit(onSubmit, onError)} noValidate>
              ...
              >
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  >
                    <Controller
                      name="idcategoriaAlergia"
                      control={control}
                      render={({ field }) => (
                        <SelectCategoria
                          field={field}
                          onChange={(e) =>
                            setValue("idcategoriaAlergia", e.target.value, {
                              shouldValidate: true,
                            })
                          }
                        ...
                        <>
                          <CssVarsProvider>
                            ...
                            <Textarea
                              ...
                              color="primary"
                              minRows={3}
                              placeholder="Digite la reacción"
                              size="lg"
                              variant="outlined"
