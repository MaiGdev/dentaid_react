...
function TableAlergiaHead(props) {
  const {
    // onSelectAllClick,
    order,
    orderBy,
...
function TableAlergiaToolbar(props) {
    ...
    >
      {numSelected > 0 ? (
        ...
        <>
          ...
          <Tooltip title="Nuevo">
            <IconButton color="secondary" component={Link} to="/alergia/create">
              <AddIcon />
            </IconButton>
          </Tooltip>
        </>
                    ...
                    >
                      ...
                      <TableBody>
                        {stableSort(data, getComparator(order, orderBy))
                          ...
                          .map((row, index) => {
                            const isItemSelected = isSelected(row.idAlergia);
                            ...
                            return (
                              <TableRow
                                hover
                                onClick={(event) =>
                                  handleClick(event, row.idAlergia)
                                }
                                role="checkbox"
