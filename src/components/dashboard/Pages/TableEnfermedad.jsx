...
function TableEnfermedadHead(props) {
  const {
    // onSelectAllClick,
    order,
    orderBy,
...
function TableEnfermedadToolbar(props) {
  const navigate = useNavigate();
  const { numSelected } = props;
  const { idSelected } = props;
  const update = () => {
    console.log(idSelected);
    return navigate(`/enfermedad/update/${idSelected}`);
  };
  return (
    <Toolbar
      sx={{
...
TableEnfermedadToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
                          ...
                          .map((row, index) => {
                            ...
                            return (
                              <TableRow
                                hover
                                onClick={(event) =>
                                  handleClick(event, row.idEnfermedad)
                                }
                                role="checkbox"
